...
\dirpath{web/redisus-frontend} & Implementa o frontend React/Next.js, com integra\c{c}\~ao com provedor anterior (descontinuado) e consumo da API cl\'inica. \\
...
\begin{itemize}
    ...
    \item compatibilidade com provedor anterior (descontinuado) para valida\c{c}\~ao de \textit{bearer token};
...
\begin{itemize}
    ...
    \item inicializa\c{c}\~ao opcional de provedor anterior (descontinuado);
